...
- Space Complexity: O(N) in the worst case (when the tree is completely unbalanced, e.g., a linked list). In the average case (for a balanced tree), the space complexity is O(W) where W is the maximum width of the tree.
